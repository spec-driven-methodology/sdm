 ...
 */
export function exportConfluence(options) {
    ...
    if (levelId) {
        ...
        for (const s of coverage.result.skills) {
            parts.push(`- ${s.statusSymbol} **${s.skill}** — questions=${s.questionCount}, depth=${s.achievedDepth}/${s.depth} (ratio=${s.depthRatio})`);
        }
        parts.push("");
...
//# sourceMappingURL=export-confluence.js.map
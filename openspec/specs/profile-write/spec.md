...
Create certification profiles independently of level certification (`profile create`).
...
- **THEN** the profile title is updated
- **AND** existing `levels` entries are preserved (not reset to empty)

...
Dynamic export-test parameter form in Methodology Studio view documents and `export_test` action handoff to an external executor, plus Player preview link — Studio does not run `export test` itself.

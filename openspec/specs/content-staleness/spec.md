...
Track content freshness for methodology library questions and export artifacts: deterministic basis fingerprints for skills and levels, optional `meta.basis` stamping on writes/exports, and a `content stale` domain operation for agents to detect mismatches and drive review or regeneration.

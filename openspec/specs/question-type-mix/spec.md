...
Type-mix presets for assessment question drafting so agents can seed homogeneous single-choice libraries or diversify across auto-checkable types without inventing deferred LMS formats.
